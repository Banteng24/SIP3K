						...
						<div class="col-12 col-lg-4">
							<div class="card">
								<div class="list-group list-group-flush" id="list-tab" role="tablist">
									<a href="#tab1" class="list-group-item list-group-item-action active" data-bs-toggle="pill" role="tab" aria-controls="tab1" aria-selected="true"> <i class='bx bx-question-mark mr-2'></i>home</a>
									<a href="#tab2" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab" aria-controls="tab2" aria-selected="false">	<i class='bx bxs-user mr-2'></i> Profile</a>
									<a href="#tab3" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab" aria-controls="tab3" aria-selected="false">	<i class='bx bxs-user-circle mr-2'></i> Account</a>
									<a href="#tab4" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab" aria-controls="tab4" aria-selected="false">	<i class='bx bxs-heart mr-2'></i> Favorites</a>
									<a href="#tab5" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab" aria-controls="tab5" aria-selected="false">	<i class='bx bxs-dollar-circle mr-2'></i> Transactions</a>
									<a href="#tab6" class="list-group-item list-group-item-action" data-bs-toggle="pill" role="tab" aria-controls="tab6" aria-selected="false">	<i class='bx bxs-help-circle mr-2'></i> General help</a>
								</div>
							</div>
						</div>
							...
							<div class="tab-content shadow" id="faq-tab-content">
								<div class="tab-pane show active" id="tab1" role="tabpanel" aria-labelledby="tab1">
									<div class="" id="accordion-tab-1">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-1-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-1-content-1" aria-expanded="false" aria-controls="accordion-tab-1-content-1">Just once I'd like to eat dinner with a celebrity?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-1-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-1-content-2" aria-expanded="false" aria-controls="accordion-tab-1-content-2">Bender, I didn't know you liked cooking?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-1-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-1-content-3" aria-expanded="false" aria-controls="accordion-tab-1-content-3">My fellow Earthicans?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-1-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-1-content-4" aria-expanded="false" aria-controls="accordion-tab-1-content-4">Who am I making this out to?</h6>
												</div>
								...
								<div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="tab2">
									<div class="" id="accordion-tab-2">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-2-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-2-content-1" aria-expanded="false" aria-controls="accordion-tab-2-content-1">Does anybody else feel jealous and aroused and worried?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-2-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-2-content-2" aria-expanded="false" aria-controls="accordion-tab-2-content-2">This opera's as lousy as it is brilliant?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-2-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-2-content-3" aria-expanded="false" aria-controls="accordion-tab-2-content-3">Who are you, my warranty?!</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-2-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-2-content-4" aria-expanded="false" aria-controls="accordion-tab-2-content-4">I haven't felt much of anything since my guinea pig died?</h6>
												</div>
								...
								<div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="tab3">
									<div class="" id="accordion-tab-3">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-3-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-3-content-1" aria-expanded="false" aria-controls="accordion-tab-3-content-1">Michelle, I don't regret this, but I both rue and lament it?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-3-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-3-content-2" aria-expanded="false" aria-controls="accordion-tab-3-content-2">Why am I sticky and naked?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-3-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-3-content-3" aria-expanded="false" aria-controls="accordion-tab-3-content-3">Is that a cooking show?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-3-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-3-content-4" aria-expanded="false" aria-controls="accordion-tab-3-content-4">You are the last hope of the universe?</h6>
												</div>
								...
								<div class="tab-pane" id="tab4" role="tabpanel" aria-labelledby="tab4">
									<div class="" id="accordion-tab-4">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-4-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-4-content-1" aria-expanded="false" aria-controls="accordion-tab-4-content-1">You, minion. Lift my arm?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-4-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-4-content-2" aria-expanded="false" aria-controls="accordion-tab-4-content-2">No, I'm Santa Claus?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-4-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-4-content-3" aria-expanded="false" aria-controls="accordion-tab-4-content-3">Belligerent and numerous?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-4-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-4-content-4" aria-expanded="false" aria-controls="accordion-tab-4-content-4">Take me to your leader?</h6>
												</div>
								...
								<div class="tab-pane" id="tab5" role="tabpanel" aria-labelledby="tab5">
									<div class="" id="accordion-tab-5">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-5-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-5-content-1" aria-expanded="false" aria-controls="accordion-tab-5-content-1">Say what?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-5-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-5-content-2" aria-expanded="false" aria-controls="accordion-tab-5-content-2">Who's brave enough to fly into something we all keep calling a death sphere?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-5-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-5-content-3" aria-expanded="false" aria-controls="accordion-tab-5-content-3">You mean while I'm sleeping in it?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-5-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-5-content-4" aria-expanded="false" aria-controls="accordion-tab-5-content-4">And until then, I can never die?</h6>
												</div>
								...
								<div class="tab-pane" id="tab6" role="tabpanel" aria-labelledby="tab6">
									<div class="" id="accordion-tab-6">
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-6-heading-1">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-6-content-1" aria-expanded="false" aria-controls="accordion-tab-6-content-1">Doomsday device?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-6-heading-2">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-6-content-2" aria-expanded="false" aria-controls="accordion-tab-6-content-2">And so we say goodbye to our beloved pet, Nibbler?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-6-heading-3">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-6-content-3" aria-expanded="false" aria-controls="accordion-tab-6-content-3">Tell her you just want to talk?</h6>
												</div>
										...
										<div class="metismenu-card">
											<div class="card mb-0 shadow-none border-bottom mm-active">
												<div class="card-header has-arrow bg-light" id="accordion-tab-6-heading-4">
													<h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#accordion-tab-6-content-4" aria-expanded="false" aria-controls="accordion-tab-6-content-4">Good man. Nixon's pro-war and pro-family?</h6>
												</div>
