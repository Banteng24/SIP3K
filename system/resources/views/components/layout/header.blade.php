<header class="top-header">
    <nav class="navbar navbar-expand">
        <div class="left-topbar d-flex align-items-center">
            <a href="{{url('public/template/user')}}/javascript:;" class="toggle-btn">	<i class="bx bx-menu"></i>
            </a>
        </div>
        ...
        <div class="right-topbar ms-auto">
            <ul class="navbar-nav">
                <li class="nav-item search-btn-mobile">
                    <a class="nav-link position-relative" href="{{url('public/template/user')}}/javascript:;">	<i class="bx bx-search vertical-align-middle"></i>
                    </a>
                </li>
                
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="{{url('public/template/user')}}/javascript:;" data-bs-toggle="dropdown">	<i class="bx bx-bell vertical-align-middle"></i>
                        <span class="msg-count">8</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <a href="{{url('public/template/user')}}/javascript:;">
                        ...
                        <div class="header-notifications-list">
                            <a class="dropdown-item" href="{{url('public/template/user')}}/javascript:;">
                ...
                <li class="nav-item dropdown dropdown-user-profile">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="{{url('public/template/user')}}/javascript:;" data-bs-toggle="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">	
                        <a class="dropdown-item" href="{{url('public/template/user')}}/javascript:;"><i
                                class="bx bx-user"></i><span>Profile</span></a>
                        <div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="{{url('public/template/user')}}/javascript:;"><i
